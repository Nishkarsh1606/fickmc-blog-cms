  ...
  <div class="sidebar-inner px-4 pt-3">
    ...
    <ul class="nav flex-column pt-3 pt-md-0">
      <li class="nav-item" href="./">
       ...
       <li class="nav-item" href="./manage-all-blogs.php">
        <a href="./manage-all-blogs.php" class="nav-link">
          <span class="sidebar-icon">
          ...
          <span class="sidebar-text">Manage All Blogs</span>
        </a>
      </li>
      <li class="nav-item" href="/manage-categories.ph">
